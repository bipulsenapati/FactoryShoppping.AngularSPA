...
export class AccountService {
  ...
  register(inputData: Account): Observable<any> {
    ...
    return this.http.post('https://localhost:5001/api/User/saveUser', inputData, headers);
  }


isAuthenticated() { // user for validation to show either login  register or signout
